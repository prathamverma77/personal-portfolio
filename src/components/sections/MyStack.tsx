...
const TechIcons: Record<string, React.JSX.Element> = {
  ...
  Firebase: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M3.9 15.9L6.5 2.5l3.4 6.4L3.9 15.9zm16.2 0L17.2 4.1l-2.4 4.5 5.3 7.3zM12 22l8.1-6.1-8.1-13.4-8.1 13.4L12 22z" />
    </svg>
  ),
  Git: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  'VS Code': (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M17.5 2.5L22 4.5v15l-4.5 2-9-7.5 4.5-2 7 5.5V6.5L13 12 8.5 8.5 17.5 2.5zM2 8.5l4.5 3.5L2 15.5V8.5z" />
    </svg>
  ),
  Vercel: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
  ...
  Docker: (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M13.8 8.8h2.3v2.3h-2.3V8.8zm-3.1 0h2.3v2.3h-2.3V8.8zm-3.1 0h2.3v2.3H7.6V8.8zm-3.1 0h2.3v2.3H4.5V8.8zm9.3-3.1h2.3v2.3h-2.3V5.7zm-3.1 0h2.3v2.3h-2.3V5.7zm-3.1 0h2.3v2.3H7.6V5.7zm9.3 0h2.3v2.3h-2.3V5.7zM2.4 12.3c-.6 0-1.1.2-1.4.6-.2.4-.2.9-.1 1.4.8 3.5 4.1 6.2 8.1 6.2 5.2 0 9.5-3.3 10.4-8h-17z" />
    </svg>
  ),
};
          ...
          {STACK_CATEGORIES.map((cat) => (
            ...
            >
              <div>
                ...
                {/* Skill Hover Cards with Pure SVG Icons */}
                  ...
                  {cat.skills.map((skill) => (
                    ...
                    >
                      <div className="flex items-center gap-2 mb-1.5">
                        <span className="text-[var(--foreground)] group-hover:scale-110 transition-transform duration-200 flex-shrink-0">
